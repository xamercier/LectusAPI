...
public class ScoreboardSign {
	...
	/**
	 * Create a scoreboard sign for a given player and using a specific
	 * objective name
	 * 
	 * @param player
	...
	public void destroy() {
		...
		for (VirtualTeam team : lines)
			if (team != null) getPlayer().sendPacket(team.removeTeam());
	...
	public void setObjectiveName(String name) {
		...
		if (created) getPlayer().sendPacket(createObjectivePacket(2, name));
	}
	...
	public void setLine(int line, String value) {
		...
		if (old != null && created) getPlayer().sendPacket(removeLine(old));
